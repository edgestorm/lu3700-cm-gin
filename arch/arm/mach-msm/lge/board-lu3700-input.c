...
static const unsigned short keypad_keymap_lu3700[][8] = {
	[LGE_REV_A] = {
...
int lu3700_matrix_info_wrapper(struct gpio_event_input_devs *input_dev,struct gpio_event_info *info, void **data, int func)
{
        int ret ;
...
static int lu3700_gpio_matrix_power(
...
static struct gpio_event_matrix_info lu3700_keypad_matrix_info = {
	.info.func	= lu3700_matrix_info_wrapper,
	.keymap		= NULL,
...
static void __init lu3700_select_keymap(void)
{
	lu3700_keypad_matrix_info.keymap = keypad_keymap_lu3700[lge_bd_rev];

	return;
}

static struct gpio_event_info *lu3700_keypad_info[] = {
	&lu3700_keypad_matrix_info.info
};

static struct gpio_event_platform_data lu3700_keypad_data = {
	.name		= "lu3700_keypad",
	.info		= lu3700_keypad_info,
	.info_count	= ARRAY_SIZE(lu3700_keypad_info),
	.power          = lu3700_gpio_matrix_power,
};

struct platform_device keypad_device_lu3700= {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &lu3700_keypad_data,
	},
};

/* keyreset platform device */
static int lu3700_reset_keys_up[] = {
	KEY_HOME,
	0
};

static struct keyreset_platform_data lu3700_reset_keys_pdata = {
	.keys_up = lu3700_reset_keys_up,
	.keys_down = {
		//KEY_BACK,
		KEY_VOLUMEDOWN,
		KEY_SEARCH,
...
struct platform_device lu3700_reset_keys_device = {
	.name = KEYRESET_NAME,
	.dev.platform_data = &lu3700_reset_keys_pdata,
};
...
#endif
static struct platform_device *lu3700_input_devices[] __initdata = {
	&hs_device,
	&keypad_device_lu3700,
	//&lu3700_reset_keys_device,
...
static void __init lu3700_init_i2c_touch(int bus_num)
{
...
static void __init lu3700_init_i2c_acceleration(int bus_num)
{
...
static void __init lu3700_init_i2c_prox_ecom(int bus_num)
{
...
{
	lu3700_select_keymap();

	platform_add_devices(lu3700_input_devices, ARRAY_SIZE(lu3700_input_devices));

	lge_add_gpio_i2c_device(lu3700_init_i2c_touch);
	lge_add_gpio_i2c_device(lu3700_init_i2c_prox_ecom);
	lge_add_gpio_i2c_device(lu3700_init_i2c_acceleration);
}
