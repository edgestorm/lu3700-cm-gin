...
int camera_power_on (void)
{
	...
	{	/* it is for rev.c and default */
		struct vreg *vreg_mmc = vreg_get(0, "rftx"); 
...
static struct platform_device *lu3700_camera_devices[] __initdata = {
#if defined (CONFIG_ISX005)
...
{
	platform_add_devices(lu3700_camera_devices, ARRAY_SIZE(lu3700_camera_devices));
}
