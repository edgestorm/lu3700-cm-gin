...
#if defined (IGNORE_BLUE_ERROR_HANDER)
int BLUE_ERROR_HANDLER_LEVEL =	0;		/* 0 --> Ignore Error Handler, 1 --> Support level 1 , 2 --> Support level 2*/
#else
...
extern void ram_console_setpanic(void);
