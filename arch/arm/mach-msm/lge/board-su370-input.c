...
static const unsigned short keypad_keymap_su370[][8] = {
	[LGE_REV_A] = {
...
int su370_matrix_info_wrapper(struct gpio_event_input_devs *input_dev,struct gpio_event_info *info, void **data, int func)
{
        int ret ;
...
static int su370_gpio_matrix_power(
...
static struct gpio_event_matrix_info su370_keypad_matrix_info = {
	.info.func	= su370_matrix_info_wrapper,
	.keymap		= NULL,
...
static void __init su370_select_keymap(void)
{
	su370_keypad_matrix_info.keymap = keypad_keymap_su370[lge_bd_rev];

	return;
}

static struct gpio_event_info *su370_keypad_info[] = {
	&su370_keypad_matrix_info.info
};

static struct gpio_event_platform_data su370_keypad_data = {
	.name		= "su370_keypad",
	.info		= su370_keypad_info,
	.info_count	= ARRAY_SIZE(su370_keypad_info),
	.power          = su370_gpio_matrix_power,
};

struct platform_device keypad_device_su370= {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &su370_keypad_data,
	},
};

/* keyreset platform device */
static int su370_reset_keys_up[] = {
	KEY_HOME,
	0
};

static struct keyreset_platform_data su370_reset_keys_pdata = {
	.keys_up = su370_reset_keys_up,
	.keys_down = {
		//KEY_BACK,
		KEY_VOLUMEDOWN,
		KEY_SEARCH,
...
struct platform_device su370_reset_keys_device = {
	.name = KEYRESET_NAME,
	.dev.platform_data = &su370_reset_keys_pdata,
};
...
static struct platform_device *su370_input_devices[] __initdata = {
	&hs_device,
	&keypad_device_su370,
	//&su370_reset_keys_device,
...
static void __init su370_init_i2c_touch(int bus_num)
{
...
static void __init su370_init_i2c_acceleration(int bus_num)
{
...
static void __init su370_init_i2c_prox_ecom(int bus_num)
{
...
void __init lge_add_input_devices(void)
{
	...
	platform_add_devices(su370_input_devices, ARRAY_SIZE(su370_input_devices));

	lge_add_gpio_i2c_device(su370_init_i2c_touch);
	lge_add_gpio_i2c_device(su370_init_i2c_prox_ecom);
	lge_add_gpio_i2c_device(su370_init_i2c_acceleration);
}
