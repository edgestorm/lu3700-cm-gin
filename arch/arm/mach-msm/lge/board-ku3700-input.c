...
static const unsigned short keypad_keymap_ku3700[][8] = {
	[LGE_REV_A] = {
...
int ku3700_matrix_info_wrapper(struct gpio_event_input_devs *input_dev,struct gpio_event_info *info, void **data, int func)
{
        int ret ;
...
static int ku3700_gpio_matrix_power(
...
static struct gpio_event_matrix_info ku3700_keypad_matrix_info = {
	.info.func	= ku3700_matrix_info_wrapper,
	.keymap		= NULL,
...
static void __init ku3700_select_keymap(void)
{
	ku3700_keypad_matrix_info.keymap = keypad_keymap_ku3700[lge_bd_rev];

	return;
}

static struct gpio_event_info *ku3700_keypad_info[] = {
	&ku3700_keypad_matrix_info.info
};

static struct gpio_event_platform_data ku3700_keypad_data = {
	.name		= "ku3700_keypad",
	.info		= ku3700_keypad_info,
	.info_count	= ARRAY_SIZE(ku3700_keypad_info),
	.power          = ku3700_gpio_matrix_power,
};

struct platform_device keypad_device_ku3700= {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &ku3700_keypad_data,
	},
};

/* keyreset platform device */
static int ku3700_reset_keys_up[] = {
	KEY_HOME,
	0
};

static struct keyreset_platform_data ku3700_reset_keys_pdata = {
	.keys_up = ku3700_reset_keys_up,
	.keys_down = {
		//KEY_BACK,
		KEY_VOLUMEDOWN,
		KEY_SEARCH,
...
struct platform_device ku3700_reset_keys_device = {
	.name = KEYRESET_NAME,
	.dev.platform_data = &ku3700_reset_keys_pdata,
};
...
static struct platform_device *ku3700_input_devices[] __initdata = {
	&hs_device,
	&keypad_device_ku3700,
...
static void __init ku3700_init_i2c_touch(int bus_num)
{
...
static void __init ku3700_init_i2c_acceleration(int bus_num)
{
...
static void __init ku3700_init_i2c_prox_ecom(int bus_num)
{
...
{
	ku3700_select_keymap();

	platform_add_devices(ku3700_input_devices, ARRAY_SIZE(ku3700_input_devices));

	lge_add_gpio_i2c_device(ku3700_init_i2c_touch);
	lge_add_gpio_i2c_device(ku3700_init_i2c_prox_ecom);
	lge_add_gpio_i2c_device(ku3700_init_i2c_acceleration);
}
