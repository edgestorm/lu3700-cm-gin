...
int ku3700_pwrsink_resume_noirq(struct device *dev)
{
...
static struct dev_pm_ops ku3700_pwrsink_data = {
	.suspend_noirq = ku3700_pwrsink_suspend_noirq,
	.resume_noirq = ku3700_pwrsink_resume_noirq,
};

static struct platform_device ku3700_pwrsink_device = {
	.name = "lge-pwrsink",
	.id = -1,
	.dev = {
		.platform_data = &ku3700_pwrsink_data,
	},
};
...
{
	lcd_bl_power_state = BL_POWER_RESUME;
	platform_device_register(&ku3700_pwrsink_device);
}
