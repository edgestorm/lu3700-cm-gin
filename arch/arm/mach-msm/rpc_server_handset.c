...
#define HS_HEADSET_K    0x7E /* 3.5PI 3P headset without mic*/ 	
...
static const uint32_t hs_key_map[] = {
	...
	KEY(HS_HEADSET_K, SW_HEADPHONE_INSERT),  /* 3.5PI 3P headset without mic*/
#ifndef CONFIG_MACH_MSM7X27_ALOHAV
	KEY(HS_ON_HOOK_K, KEY_MEDIA), //KEY_HEADSETHOOK
