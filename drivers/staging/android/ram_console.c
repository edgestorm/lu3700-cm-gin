...
ram_console_save_old(struct ram_console_buffer *buffer, char *dest)
{
...
#if 1
    /* when ram_console_buffer_size is same with ram_console_old_log_size,
     * kernel messages was circulated to the top of a console buffer
     */
    ...
    /* if else,
     * kernel messages didn't reach at the end of the console buffer
     */
    else // ram_console_old_log_size < ram_console_buffer_size
    {
        memcpy(ram_console_old_log,
